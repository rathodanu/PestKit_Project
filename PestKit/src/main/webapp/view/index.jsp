                ...
                <div class="d-flex justify-content-between topbar py-2">
                    ...
                    <div class="text-end pe-4 me-4 border-end border-dark search-btn">
                        <div class="search-form">
                            <form method="post" action="indexpage">
        ...
        <div class="container-fluid bg-dark">
            <div class="container">
                <nav class="navbar navbar-dark navbar-expand-lg py-lg-0">
                    <a href="indexPage" class="navbar-brand">
                    ...
                    <div class="collapse navbar-collapse me-n3" id="navbarCollapse">
                        <div class="navbar-nav ms-auto">
                            <a href="ShowPage" class="nav-item nav-link active">Home</a>
                            <a href="aboutPage" class="nav-item nav-link">About</a>
                            <a href="servicePage" class="nav-item nav-link">Services</a>
                            <a href="projectPage" class="nav-item nav-link">Projects</a>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                                <div class="dropdown-menu m-0 bg-primary">
                                    <a href="pricePage" class="dropdown-item">Pricing Plan</a>
                                    <a href="blogPage" class="dropdown-item">Blog Post</a>
                                    <a href="teamPage" class="dropdown-item">Team Members</a>
                                    <a href="testimonialPage" class="dropdown-item">Testimonial</a>
                                     <a href="testimonialPage" class="dropdown-item">Testimonial</a>
        ...
        <div class="container-fluid py-5 wow fadeInUp" data-wow-delay=".3s">
            <div class="container py-5">
                <div class="bg-light px-4 py-5 rounded">
                    ...
                    <form class="text-center mb-4" action="#" method="post" >
                        <div class="row g-4">
                            <div class="col-xl-10 col-lg-12">
                                <div class="row g-4">
                                    <div class="col-md-6 col-xl-3">
                                        <select class="form-select p-3 border-0">
                                            <option value="Type Of Service" class="" name="service">Type Of Service</option>
                                    ...
                                    <div class="col-md-6 col-xl-3">
                                        <input type="text" class="form-control p-3 border-0"name="name" placeholder="Name">
                                    </div>
                                    <div class="col-md-6 col-xl-3">
                                        <input type="text" class="form-control p-3 border-0" name="mobile"placeholder="Phone">
                                    </div>
                                    <div class="col-md-6 col-xl-3">
                                        <input type="email" class="form-control p-3 border-0" name="email" placeholder="Email">
                                    </div>
                                </div>
                            </div> 
                            <div class="col-xl-2 col-lg-12">
                                <button class="btn btn-primary w-100 p-3 border-0" type="submit" formaction="servicePagePermission" > Get Start</button>
            ...
            <div class="container">
                <div class="row g-4">
                    ...
                    <div class="col-lg-6 my-auto">
                        ...
                        <form method="post" action="indexPagePermission">
                            <div class="form-group">
                                <div class="d-flex call-btn">
                                
									
                                    <input type="search" class="form-control py-3 px-4 w-100 border-0 rounded-0 rounded-end rounded-pill" name="email" value="" placeholder="Enter Your Email Address" required="Please enter a valid email"/>
                                    <button type="email" value="Search Now!" class="btn btn-primary border-0 rounded-pill rounded rounded-start px-5">SignUp`</button>
                                </div>
                            </div>
                        </form>  
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                           <h4 class="text-white fw-bold mb-4">Contact Us</h4>
                            <a href="" class="btn btn-link w-100 text-start ps-0 pb-3 border-bottom rounded-0"><i class="fa fa-map-marker-alt me-3"></i>Karvenage Pune 52</a>
                            <a href="" class="btn btn-link w-100 text-start ps-0 py-3 border-bottom rounded-0"><i class="fa fa-phone-alt me-3"></i>8180839372</a>
                            <a href="" class="btn btn-link w-100 text-start ps-0 py-3 border-bottom rounded-0"><i class="fa fa-envelope me-3"></i>rathodanu@gmail.com</a>
                        </div>
                    </div>
                </div>
            </div>
