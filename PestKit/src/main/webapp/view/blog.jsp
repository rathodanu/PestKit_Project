            ...
            <div class="container">
                <div class="d-flex justify-content-between topbar py-2">
                    <div class="d-flex align-items-center flex-shrink-0 topbar-info">
                        <a href="#" class="me-4 text-secondary"><i class="fas fa-map-marker-alt me-2 text-dark"></i>Karvenagar Pune 52</a>
                        <a href="#" class="me-4 text-secondary"><i class="fas fa-phone-alt me-2 text-dark"></i>+8180839372</a>
                        <a href="#" class="text-secondary"><i class="fas fa-envelope me-2 text-dark"></i>rathodanu@gmail.com</a>
                    </div>
                        ...
                        <div class="navbar-nav ms-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-primary">
                                    ...
                                    <a href="blogPage" class="dropdown-item active">Blog Post</a>
            ...
            <div class="container text-center py-5">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center mb-0 animated slideInDown">
                        ...
                        <li class="breadcrumb-item"><a href="pricePage">Pages</a></li>
                ...
                <div class="row g-4 footer-inner">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p class="mb-0"><a class="" href="#">PestKit </a> &copy; 2024 All Right Reserved.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
