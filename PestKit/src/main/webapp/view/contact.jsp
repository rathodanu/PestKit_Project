        ...
        <div class="container-fluid bg-dark">
            <div class="container">
                <nav class="navbar navbar-dark navbar-expand-lg py-lg-0">
                    <a href="ShowPage" class="navbar-brand">
                    ...
                    <div class="collapse navbar-collapse me-n3" id="navbarCollapse">
                        <div class="navbar-nav ms-auto">
                            <a href="ShowPage" class="nav-item nav-link">Home</a>
            ...
            <div class="container text-center py-5">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center mb-0 animated slideInDown">
                        <li class="breadcrumb-item"><a href="ShowPage">Home</a></li>
                        <li class="breadcrumb-item"><a href="projectPage">Pages</a></li>
            ...
            <div class="container py-5">
                ...
                <div class="row g-5 mb-5">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay=".5s">
                            ...
                            <div class="mb-4">
                                <input type="text" class="form-control p-3" name="mobile" placeholder="Enter Mobile Number">
                            </div>
                            <div class="mb-4">
                    ...
                    <div class="col-xxl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="d-flex bg-light p-3 rounded contact-btn-link">
                            ...
                            <div class="ms-3 contact-link">
                                ...
                                <a href="#">
                                    <h5 class="text-dark d-inline fs-6">Karvenagar Pune 52</h5>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="d-flex bg-light p-3 rounded contact-btn-link">
                            ...
                            <div class="ms-3 contact-link">
                                ...
                                <a class="h5 text-dark fs-6" href="tel:+0123456789">8180839372</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="d-flex bg-light p-3 rounded contact-btn-link">
                            ...
                            <div class="ms-3 contact-link">
                                ...
                                <a class="h5 text-dark fs-6" href="#">rathodanu@gmail.com</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-4 footer-inner">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <div class="d-flex flex-column align-items-start">
                                <a class="btn btn-link ps-0" href="aboutPage"><i class="fa fa-check me-2"></i>About Us</a>
                                <a class="btn btn-link ps-0" href="contactPage"><i class="fa fa-check me-2"></i>Contact Us</a>
                                <a class="btn btn-link ps-0" href="servicePage"><i class="fa fa-check me-2"></i>Our Services</a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <a href="" class="btn btn-link w-100 text-start ps-0 pb-3 border-bottom rounded-0"><i class="fa fa-map-marker-alt me-3"></i>Karvenagar Pune 52</a>
